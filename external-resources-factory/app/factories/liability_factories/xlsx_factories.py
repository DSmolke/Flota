...
@dataclass
class FromXlsxToLiabilitiesWithExpectedConstraintsDataFactory(DataFactory):
    """
...
@dataclass
class FromXlsxStrAdapterToLiabilitiesWithExpectedConstraintsDataFactory(DataFactory):
    """
    path: path of xlsx file that has to load cars information
